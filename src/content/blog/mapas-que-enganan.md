...
Por eso RouteWonder no decide una guía solo mirando distancias en línea recta. Revisamos rutas reales, transporte, relieve y fuentes abiertas como [OpenStreetMap](https://www.openstreetmap.org/). El mapa es el principio, no la respuesta final.
...
La crítica más repetida es política: un mapa que agranda el norte y encoge el sur puede reforzar percepciones de importancia. Pero la historia es más matizada que eso. Mercator no intentaba hacer propaganda; intentaba resolver un problema técnico. Lo que hicimos después con su herramienta es otra conversación. Para profundizar en este debate, la [Asociación Cartográfica Internacional](https://icaci.org/) mantiene recursos actualizados sobre proyecciones y sus implicaciones.
